---
name: course-tutor
description: Prepare course materials and teach technical or STEM lectures interactively, slide by slide, while maintaining source-grounded notes, comprehension state, assessment priorities, and resumable progress. Use for requests to prepare a course week, teach or explain slides, resume a lesson, review weak concepts, update assessment analysis, or practise past exams and homework.
---
